...
- abstract: Graphical MS Windows user interface for
  ...
  volume: 2025
- abstract: Applications for calculating (i) distribution functions and
    bootstrap estimators, (ii) various parameters within the framework
    of psychophysiological EEG measurements, (iii) integral and
    interpolation and (iv) matrix parameters. Further applications are
    (v) string- and number- transformation tools and finally (vi)
    various console tools. Certain applications are implemented in the
    Windows Tools (i) FunktionWin, (ii) ThetaWin and (iii) ATINA.
  author:
  - literal: Schrausser, D. G.
  container-title: Zenodo Software documentation
  doi: 10.5281/zenodo.19546342
  id: schrausser_2026_19546342
  issue: 04/13
  issued: 2026-04
  keyword: binomial bootstrapping calculus eeg erd fourier-analysis
    hp_prime hypergeometric mathematics myown neural_efficiency
    neuropsychology probability psychophysiology resampling simulation
    software statistics strings t_Distribution
  page: 1-18
  publisher: Zenodo
  title: Console applications for mathematical functions, EEG signal
    analysis, string manipulation and utilities
  type: article-journal
