...
- author:
  - literal: Schrausser, D. G.
  doi: 10.17605/OSF.IO/VDX25
  id: schrausser_2025_10.17605/OSF.IO/VDX25
  issued: 2025-12
  publisher: Open Science Framework OSF
  title: "Sim01/simulation study: Mean dispersion"
  title-short: Sim01/simulation study
- author:
  - literal: Schrausser, D. G.
  doi: 10.17605/OSF.IO/DRBC9
  id: schrausser_2025_10.17605/OSF.IO/DRBC9
  issued: 2025-12
  publisher: Open Science Framework OSF
  title: "Sim03/simulation study: correlation"
  title-short: Sim03/simulation study
- author:
  - literal: Schrausser, D. G.
  doi: 10.17605/OSF.IO/J5BR9
  id: "https://doi.org/10.17605/osf.io/j5br9"
  issued: 2026-01
  keyword: "The Sun and the Solar System, Medieval Studies, Astrophysics
    and Astronomy, History of Christianity, European History,
    Philosophy, FOS: Philosophy, ethics and religion, Religious Thought,
    Theology and Philosophy of Religion, Physical Sciences and
    Mathematics, Medieval History, History of Religion, Other
    Astrophysics and Astronomy, History, Religion, Arts and Humanities,
    Christianity, Logic and Foundations of Mathematics, Ethics in
    Religion, Philosophy of Mind, German Language and Literature,
    Metaphysics, Epistemology, Biblical Studies, aristotle, cicero,
    cosmology, greek-philosophy, hylomorphisms, medieval-latin,
    medieval-manuscripts, medieval-philosophy, metaphysics, mirandola,
    moon, nuremberg-chronicle, philosophy-of-mind, planets-orbiting,
    plato, ptolemaic-system, ptolemy, renaissance-literature,
    septuaginta, solar-system, yle"
  publisher: Open Science Framework OSF
  title: The nuremberg chronicle 1493
  url: "https://osf.io/j5br9/"
- abstract: Literature sources and references for the Nuremberg
    Chronicle, fol. Ir to VIIr, the preface up to the fall of man are
    the Heptaplus and Oratio de hominis dignitate (Mirandola &
    Mirandola, 1601, p. 1 ff., p. 207 ff., res.), Genesis, the first
    book of Moses (Jiménez de Cisneros, 1517, fol. a ff.), the
    Supplementum Chronicarum (Foresti, 1492, fol. a2r ff.), the
    Metamorphoses of Ovid (1515, fol. 1r), De Legibus (Cicero & Cicero,
    1496, p. aaiii), the Historia Naturalis (Plinius Secundus, 1250,
    fol. 22r; c.f. De Beauvais, 1964), De Caelesti Hierarchia
    (Dionysius, 1350) and the Chronica Majora (De Seville, 1802, p.
    285). See further Genealogiae deorum gentilium (Boccaccio, 1360),
    Plato's Timaeus (Plato, 1588, p. 456 ff.), Aristotle's Metaphsics
    (Aristoteles & Theophrastus, 1608), the Odes of Horace (1868), the
    Enneads of Plotinus (1580), Homiliae in Evangelia of Gregory the
    Great (Étaix, 1999) and The Gospel of Matthew (Jiménez de Cisneros,
    1517). On original sources see Diels (1906), Janko (2002) and
    Benaissa et al. (2025).
  author:
  - literal: Schrausser, D. G.
  doi: 10.5281/zenodo.19239636
  id: schrausser2026nuremberg
  issued: 2026
  keyword: Chronology Cosmology History Philosophy myown
  publisher: Zenodo
  title: "Schrausser/the_nuremberg_chronicle_1493_sources: 1.0"
  title-short: Schrausser/the_nuremberg_chronicle_1493_sources
  type: dataset
  url: "https://github.com/Schrausser/The_Nuremberg_Chronicle_1493_Sources"
---
